                     ...
                     <table class="table table-bordered theme_table" id="u_table" data-page-length='10'>
                        <thead>
                           <tr>
                              ...
                              <th><?php echo $assArr['ship_quantity'];?></th>
                              ...
                              <th><?php echo $assArr['gROSS_WT'];;?></th>
                               <?php } ?>
                              <th><?php echo $assArr['view_image'];?></th>
