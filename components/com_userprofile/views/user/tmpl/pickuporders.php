...
$joomla(document).ready(function(){
	...
	$joomla("form[name='userprofileFormThree']").validate({
		...
		messages: {
			fnameTxt:{
			    required: "<?php echo $assaArr['first_name_error'];?>",
			    alphanumeric: "please enter alphabet characters"
			},
			lnameTxt:{
			    required: "<?php echo $assaArr['last_Name_error'];?>",
			    alphanumeric: "please enter alphabet characters"
			},
            country2Txt: {
             required: "<?php echo $assaArr['country_error'];?>"
            ...
            addressTxt:{
              required: "<?php echo $assaArr['additional_address_error'];?>"
            },
            zipTxt:{
              required: "<?php echo $assaArr['zip_code_error'];?>"
            }
