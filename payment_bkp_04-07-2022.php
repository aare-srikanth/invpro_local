        ...
        foreach($_FILES['invFile']['name'] as $key=>$mage){
            ...
            $filenameStr .= $profilepicname.',';
                ...
                $invf .= '0,';
                    ...
                    $status=Controlbox::submitpayshopperassist($CustId,$itemPrice,$card_number,$txtccnumberStr, $card_exp_month,  $txtNameonCardStr, $card_exp_year,$specialinstructionStr,$txtTaxesStr,$txtShippChargesStr,$invidkStr,$qtyStr,$articleStr,$txtPaymentMethod,$pg,'','',$tid);
